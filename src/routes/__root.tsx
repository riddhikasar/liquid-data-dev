...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Liquid Data — Turn memories into tangible experiences" },
      { name: "description", content: "Describe a memory and Liquid Data crafts a unique drink recipe that captures its essence." },
      { property: "og:title", content: "Liquid Data — Turn memories into tangible experiences" },
      { property: "og:description", content: "Describe a memory and Liquid Data crafts a unique drink recipe that captures its essence." },
